...
function getSalaryAverage2($callback, $jobListing)
{
    ...
    <div class="max-w-xl mx-auto">
        ...
        <div class="bg-green-100 rounded-lg shadow-md p-6 my-6">
            <h2 class="text-2xl font-semibold mb-4">
                Average Salary: <?= getSalaryAverage2($format, $listings) ?>
            </h2>
        </div>
        <?php foreach ($listings as $index => $job) : ?>
            <div class="mb-4 p-4 shadow-md rounded-lg <?= $index % 2 === 0 ? 'bg-blue-100' : 'bg-white' ?>">
                ...
                <div class="mt-4">
                    <p class="font-semibold">Salary: <span class="font-normal"><?= $format($job['salary']) ?></span></p>
